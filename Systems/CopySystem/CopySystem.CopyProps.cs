...
namespace ctrlC.Systems
{
    ...
    {
        private static void CopyProps(List<Entity> props, EntityManager entityManager, PrefabSystem prefabSystem, List<ObjectSubObjectInfo> subObjectInfos)
        {
            foreach (var selectedEntity in props)
            {
